...
export function Icon6({width, height, color}: IIcon) {
    return (
        <svg stroke={color} fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height={height} width={width} xmlns="http://www.w3.org/2000/svg">
